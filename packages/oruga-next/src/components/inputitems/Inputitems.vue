...
export default defineComponent({
    ...
    props: {
        ...
        confirmKeys: {
            type: Array,
            default: () => {
                return getValueByPath(getOptions(), "inputitems.confirmKeys", [
                    ",",
                    "Tab",
                    "Enter",
                ]);
        ...
        removeOnKeys: {
            type: Array,
            default: () => {
                return getValueByPath(getOptions(), "inputitems.removeOnKeys", [
                    "Backspace",
                ]);
            },
        },
        ...
        autocompleteClasses: {
            ...
            default: () => {
                return getValueByPath(
                    getOptions(),
                    "inputitems.autocompleteClasses",
                    {},
                );
            },
        },
        ...
        addItem(item) {
            ...
            if (itemToAdd) {
                ...
                const add = !this.allowDuplicates
                    ? this.items.indexOf(this.createItem(itemToAdd)) === -1
                    : true;
