...
| appendToBody     | Append dropdown content to body                                                                                                                        | boolean                                | -                                        | <code style='white-space: nowrap; padding: 0;'></code>                                                                                                    |
| ariaRole         | Role attribute to be passed to list container for better accessibility. Use menu only in situations where your dropdown is related to navigation menus | string                                 | `list`, `menu`, `dialog`                 | <code style='white-space: nowrap; padding: 0;'>null</code>                                                                                                |
...
| disabled         | Dropdown disabled                                                                                                                                      | boolean                                | -                                        | <code style='white-space: nowrap; padding: 0;'></code>                                                                                                    |
